                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="radio" name="option{{ $option->id }}" id="option" value="{{ $option->id }}" onchange="selectOption(this.value, {{$candidateQuestion->id}})" {{ $option->id == $candidateQuestion->candidate_option ? 'checked' : '' }}>
                    ...
                    <div class="col-xxl-3">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="card card-body">
                                    <h5 class="fs-14 mb-2">Examination Timer</h5>
                                    <br>
                                    <h5 id="demo"></h5>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    <div class="modal-body text-center p-5">
                        ...
                        <div class="mt-2">
                            ...
                            <p class="text-muted"> You have answered <span class="text-warning" id="answeredQuestions">{{ $candidateQuestions->where("candidate_option", "!=", null)->count() }}</span> of {{ $candidateQuestions->count() }} questions</p>
